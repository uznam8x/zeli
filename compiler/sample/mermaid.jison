...
start
  : mermaidDoc
    { console.log('215: mermaidDoc 2')}
  | directive start
    { console.log('218: directive start')}
  ;
...
graphConfig
    ...
    | GRAPH DIR FirstStmtSeperator
        ...
        { console.log('277:', $1, $2, $3); yy.setDirection($2);$$ = $2;}
...
link: linkStatement arrowText
    ...
    | START_LINK text LINK
        {console.log('411:', $1, $2, $3); var inf = yy.destructLink($3, $1); $$ = {"type":inf.type,"stroke":inf.stroke,"text":$2};}
    ;
